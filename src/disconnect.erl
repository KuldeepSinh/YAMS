...
%%% @copyright (C) 2013, 
%%% @doc
%%%    This module will handle requests to disconnect
%%% @end
%%% Created : 17 Aug 2013 by KuldeepSinh Chauhan
%%% Updated : 05 Feb 2015 by KuldeepSinh Chauhan
%%%-------------------------------------------------------------------
%%%-------------------------------------------------------------------
%%% NOTE : CODE FOLLOWING IS PLACE HOLDER ONLY, NEEDS TO BE IMPLMENTED AS THE LOGIC REQURIED.
%%%-------------------------------------------------------------------
-module(disconnect).
...
create(APid, Msg) ->
    disconnect_sup:start_child(APid, Msg).
