...
%%% @copyright (C) 2013, 
%%% @doc
%%%    This module will handle requests to unsubscribe topics.
%%% @end
%%% Created : 29 Aug 2013 by KuldeepSinh Chauhan
%%% Updated : 05 Feb 2015 by KuldeepSinh Chauhan
%%%-------------------------------------------------------------------
%%%-------------------------------------------------------------------
%%% NOTE : - CODE FOLLOWING HERE IS PLACE HOLDER ONLY, NEEDS TO BE IMPLEMENTED AS PER THE LOGIC REQUIRED.
%%%-------------------------------------------------------------------
-module(unsubscribe).
...
create(APid, ClientID, Dup, Msg) ->
    unsubscribe_sup:start_child(APid, ClientID, Dup, Msg).
